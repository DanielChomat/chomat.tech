...
const projectsData = [
  {
    ...
    company: {
      name: "SocialSharks",
      logo: null,
      description: "Aquarium full of specialists",
    },
    links: {
      code: null,
      live: "https://www.pokladloyd.cz/",
    },
    details: {
  ...
  {
    position: "🚂 seat reservation interface",
    featured: false,
    company: {
      name: "Nostalgic trains agency",
    },
    links: {
      code: "https://github.com/DanielChomat/JS-Experiments/tree/master/train-seat-selector",
      live: "https://experiments.chomat.tech/train-seat-selector/",
    },
    details: {
    ...
    projects: [
      "All-CSS Grid Reservation system",
      "Connecting to Wordpress back-end",
    ],
    tech: ["SCSS", "CSS Grid", "Bootstrap", "Vanilla JS", "Wordpress"],
  },
  {
  ...
  {
    position: "Simple WP e-shop Wordpress plugin",
    featured: false,
    company: {
      name: "Kid's pool",
      logo: null,
      ...
      >
        {projectsData.map(project => (
          <Experience project>
            ...
            <h5>Projects</h5>
            <section>
              {project.projects.map(learnings => (
                <span>{learnings}</span>
              ))}
            </section>
