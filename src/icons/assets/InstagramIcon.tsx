export const InstagramIcon = () => (
  <svg width={"4.8rem"} height={"4.8rem"} viewBox="0 0 512 512">
    ...
    >
      ...
      <stop offset=".054" stopColor="#fadc04" />
      <stop offset=".117" stopColor="#fbce0e" />
      <stop offset=".183" stopColor="#fcb720" />
      <stop offset=".251" stopColor="#fe9838" />
      <stop offset=".305" stopColor="#ff7950" />
      <stop offset=".492" stopColor="#ff1c74" />
    ...
    >
      ...
      <stop offset=".307" stopColor="#fca800" stopOpacity=".306" />
      <stop offset=".627" stopColor="#fe7300" stopOpacity=".627" />
      <stop offset=".869" stopColor="#ff5200" stopOpacity=".867" />
    ...
    >
      ...
      <stop offset=".092" stopColor="#9c3495" />
      <stop offset=".293" stopColor="#dc2546" />
      <stop offset=".392" stopColor="#fd1d1d" />
      <stop offset=".559" stopColor="#fc6831" />
      <stop offset=".689" stopColor="#fc9b40" />
      <stop offset=".752" stopColor="#fcaf45" />
      <stop offset=".781" stopColor="#fdb750" />
      <stop offset=".866" stopColor="#fecb6a" />
      <stop offset=".942" stopColor="#ffd87a" />
